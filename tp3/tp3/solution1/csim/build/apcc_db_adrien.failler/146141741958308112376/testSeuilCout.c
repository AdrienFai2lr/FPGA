...
void detectCoul(signed int *, l_struct_OC_pixelType );
...
static  char aesl_internal__OC_str7[43] = "Valeur de i : %d, valeur du resultat : %d\n";
...
signed int main(void) {
  ...
  l_struct_OC_pixelType llvm_cbe_resOut;    /* Address-exposed local */
...
llvm_cbe_tmp__26:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([48 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds %%struct.pixelType* %%res, i64 0, i32 2, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__3 = (signed int *)(&llvm_cbe_res.field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds %%struct.pixelType* %%res, i64 0, i32 1, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__4 = (signed int *)(&llvm_cbe_res.field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds %%struct.pixelType* %%res, i64 0, i32 0, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__5 = (signed int *)(&llvm_cbe_res.field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds %%struct.pixelType* %%resOut, i64 0, i32 0, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_31_count);
  llvm_cbe_tmp__6 = (signed int *)(&llvm_cbe_resOut.field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds %%struct.pixelType* %%resOut, i64 0, i32 1, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__7 = (signed int *)(&llvm_cbe_resOut.field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds %%struct.pixelType* %%resOut, i64 0, i32 2, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__8 = (signed int *)(&llvm_cbe_resOut.field2);
if (AESL_DEBUG_TRACE) {
}
...
llvm_cbe_tmp__29:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts1 = call i32 @puts(i8* getelementptr inbounds ([53 x i8]* @aesl_internal_str1, i64 0, i64 0)), !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_puts1_count);
...
llvm_cbe_tmp__30:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ 0, %%.preheader ], [ %%28, %%14  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = call i32 (%%struct._IO_FILE*, i8*, ...)* @__isoc99_fscanf(%%struct._IO_FILE* %%1, i8* getelementptr inbounds ([3 x i8]* @aesl_internal_.str6, i64 0, i64 0), i32* %%r) nounwind, !dbg !10 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 (%%struct._IO_FILE*, i8*, ...)* @__isoc99_fscanf(%%struct._IO_FILE* %%1, i8* getelementptr inbounds ([3 x i8]* @aesl_internal_.str6, i64 0, i64 0), i32* %%g) nounwind, !dbg !10 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_37_count);
  __isoc99_fscanf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__1, ( char *)((&aesl_internal__OC_str6[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = call i32 (%%struct._IO_FILE*, i8*, ...)* @__isoc99_fscanf(%%struct._IO_FILE* %%1, i8* getelementptr inbounds ([3 x i8]* @aesl_internal_.str6, i64 0, i64 0), i32* %%b) nounwind, !dbg !10 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_38_count);
  __isoc99_fscanf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__1, ( char *)((&aesl_internal__OC_str6[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i32* %%b, align 4, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__12 = (unsigned int )*(&llvm_cbe_b);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%18, i32* %%7, align 4, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_46_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__12;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i32* %%g, align 4, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_53_count);
  llvm_cbe_tmp__13 = (unsigned int )*(&llvm_cbe_g);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%19, i32* %%8, align 4, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_54_count);
  *llvm_cbe_tmp__4 = llvm_cbe_tmp__13;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = load i32* %%r, align 4, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  llvm_cbe_tmp__14 = (unsigned int )*(&llvm_cbe_r);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%20, i32* %%9, align 4, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
  *llvm_cbe_tmp__5 = llvm_cbe_tmp__14;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  call void @detectCoul(i32* %%10, %%struct.pixelType* byval align 8 %%res) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_63_count);
  detectCoul((signed int *)llvm_cbe_tmp__6, llvm_cbe_res);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([43 x i8]* @aesl_internal_.str7, i64 0, i64 0), i32 %%storemerge2, %%struct.pixelType* byval align 8 %%resOut) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_64_count);
  printf(( char *)((&aesl_internal__OC_str7[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 43
#endif
])), llvm_cbe_storemerge2, llvm_cbe_resOut);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge2 = 0x%X",llvm_cbe_storemerge2);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__15);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = load i32* %%10, align 4, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
  llvm_cbe_tmp__16 = (unsigned int )*llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 %%22) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_66_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = load i32* %%11, align 4, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
  llvm_cbe_tmp__18 = (unsigned int )*llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 %%24) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_68_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i32* %%12, align 4, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_69_count);
  llvm_cbe_tmp__20 = (unsigned int )*llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 %%26) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = add nsw i32 %%storemerge2, 1, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_71_count);
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__22&4294967295ull)));
  if (((llvm_cbe_tmp__22&4294967295U) == (107200u&4294967295U))) {
...
llvm_cbe_tmp__31:
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i32 @fclose(%%struct._IO_FILE* %%1) nounwind, !dbg !10 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  fclose((l_struct_OC__IO_FILE *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__23);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = call i32 @fclose(%%struct._IO_FILE* %%2) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_78_count);
...
llvm_cbe_tmp__28:
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = phi i32 [ 0, %%29 ], [ 1, %%13 ], [ 1, %%4  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_80_count);
