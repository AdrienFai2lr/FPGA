...
void detectCoul( char *llvm_cbe_resultats,  char *llvm_cbe_valid, l_struct_OC_pixelType llvm_cbe_pixIn);
void traitCoul(l_struct_OC_pixelType *llvm_cbe_pixIn, l_struct_OC_pixelType *llvm_cbe_pixOut,  char *llvm_cbe_resultats,  char *llvm_cbe_valid);
...
printf("\n\{ BEGIN @seuilCout\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds %%struct.pixelType* %%pixIn, i64 0, i32 2, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_6_count);
  llvm_cbe_tmp__1 = (signed int *)(&llvm_cbe_pixIn.field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i32* %%1, align 8, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_7_count);
  llvm_cbe_tmp__2 = (unsigned int )*llvm_cbe_tmp__1;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds %%struct.pixelType* %%pixIn, i64 0, i32 1, !dbg !7 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__3 = (signed int *)(&llvm_cbe_pixIn.field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i32* %%3, align 4, !dbg !7 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_15_count);
  llvm_cbe_tmp__4 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds %%struct.pixelType* %%pixIn, i64 0, i32 0, !dbg !7 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__5 = (signed int *)(&llvm_cbe_pixIn.field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i32* %%5, align 8, !dbg !7 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_23_count);
  llvm_cbe_tmp__6 = (unsigned int )*llvm_cbe_tmp__5;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = or i1 %%7, %%8, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
...
printf("\nor.cond = 0x%X\n", llvm_cbe_or_2e_cond);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = select i1 %%or.cond, i32 0, i32 %%6, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__7 = (unsigned int )((llvm_cbe_or_2e_cond) ? ((unsigned int )0u) : ((unsigned int )llvm_cbe_tmp__6));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond1 = or i1 %%10, %%11, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_or_2e_cond1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = select i1 %%or.cond1, i32 0, i32 %%4, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__8 = (unsigned int )((llvm_cbe_or_2e_cond1) ? ((unsigned int )0u) : ((unsigned int )llvm_cbe_tmp__4));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond2 = or i1 %%13, %%14, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_or_2e_cond2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = select i1 %%or.cond2, i32 0, i32 %%2, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__9 = (unsigned int )((llvm_cbe_or_2e_cond2) ? ((unsigned int )0u) : ((unsigned int )llvm_cbe_tmp__2));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = getelementptr inbounds %%struct.pixelType* %%pixOut, i64 0, i32 2, !dbg !5 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__10 = (signed int *)(&llvm_cbe_pixOut->field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%15, i32* %%16, align 4, !dbg !5 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_49_count);
  *llvm_cbe_tmp__10 = llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = getelementptr inbounds %%struct.pixelType* %%pixOut, i64 0, i32 1, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_50_count);
  llvm_cbe_tmp__11 = (signed int *)(&llvm_cbe_pixOut->field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%12, i32* %%17, align 4, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_51_count);
  *llvm_cbe_tmp__11 = llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds %%struct.pixelType* %%pixOut, i64 0, i32 0, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_52_count);
  llvm_cbe_tmp__12 = (signed int *)(&llvm_cbe_pixOut->field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%9, i32* %%18, align 4, !dbg !6 for 0x%llxth hint within @seuilCout  --> \n", ++aesl_llvm_cbe_53_count);
...
void detectCoul( char *llvm_cbe_resultats,  char *llvm_cbe_valid, l_struct_OC_pixelType llvm_cbe_pixIn) {
  ...
  static  unsigned long long aesl_llvm_cbe_or_2e_cond34_count = 0;
  bool llvm_cbe_or_2e_cond34;
  ...
  unsigned char llvm_cbe_storemerge28;
  static  unsigned long long aesl_llvm_cbe_209_count = 0;
  static  unsigned long long aesl_llvm_cbe_storemerge33_count = 0;
  unsigned char llvm_cbe_storemerge33;
  unsigned char llvm_cbe_storemerge33__PHI_TEMPORARY;
...
printf("\n\{ BEGIN @detectCoul\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds %%struct.pixelType* %%pixIn, i64 0, i32 0, !dbg !8 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_73_count);
  llvm_cbe_tmp__13 = (signed int *)(&llvm_cbe_pixIn.field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i32* %%1, align 8, !dbg !8 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__14 = (unsigned int )*llvm_cbe_tmp__13;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds %%struct.pixelType* %%pixIn, i64 0, i32 1, !dbg !10 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_91_count);
  llvm_cbe_tmp__15 = (signed int *)(&llvm_cbe_pixIn.field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i32* %%3, align 4, !dbg !10 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_92_count);
  llvm_cbe_tmp__16 = (unsigned int )*llvm_cbe_tmp__15;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds %%struct.pixelType* %%pixIn, i64 0, i32 2, !dbg !11 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_107_count);
  llvm_cbe_tmp__17 = (signed int *)(&llvm_cbe_pixIn.field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i32* %%5, align 8, !dbg !11 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_108_count);
  llvm_cbe_tmp__18 = (unsigned int )*llvm_cbe_tmp__17;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  store i8 0, i8* %%valid, align 1, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_125_count);
  *llvm_cbe_valid = ((unsigned char )0);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned char )0));
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = and i1 %%7, %%8, !dbg !8 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
...
llvm_cbe_tmp__49:
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_129_count);
  llvm_cbe_tmp__19 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = add nsw i32 %%10, 1, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_130_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%11, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_131_count);
...
llvm_cbe_tmp__50:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond1 = and i1 %%13, %%14, !dbg !9 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond1_count);
...
llvm_cbe_tmp__52:
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_136_count);
  llvm_cbe_tmp__21 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = add nsw i32 %%16, 1, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_137_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%17, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_138_count);
...
llvm_cbe_tmp__53:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond2 = and i1 %%19, %%20, !dbg !9 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond2_count);
...
llvm_cbe_tmp__55:
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_143_count);
  llvm_cbe_tmp__23 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = add nsw i32 %%22, 1, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_144_count);
  llvm_cbe_tmp__24 = (unsigned int )((unsigned int )(llvm_cbe_tmp__23&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__24&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%23, i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !12 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_145_count);
...
llvm_cbe_tmp__56:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond3 = and i1 %%25, %%8, !dbg !9 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond3_count);
...
llvm_cbe_tmp__58:
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_149_count);
  llvm_cbe_tmp__25 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = add nsw i32 %%27, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_150_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%28, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_151_count);
  *(&aesl_internal_detectCoul_OC_cptR) = llvm_cbe_tmp__26;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_152_count);
  llvm_cbe_tmp__27 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = add nsw i32 %%29, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_153_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%30, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_154_count);
...
llvm_cbe_tmp__59:
if (AESL_DEBUG_TRACE)
printf("\n  %%brmerge.demorgan = and i1 %%32, %%7, !dbg !9 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_brmerge_2e_demorgan_count);
...
llvm_cbe_tmp__61:
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_158_count);
  llvm_cbe_tmp__29 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = add nsw i32 %%34, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_159_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%35, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_160_count);
  *(&aesl_internal_detectCoul_OC_cptR) = llvm_cbe_tmp__30;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_161_count);
  llvm_cbe_tmp__31 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = add nsw i32 %%36, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_162_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%37, i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_163_count);
...
llvm_cbe_tmp__65:
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_166_count);
  llvm_cbe_tmp__33 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = add nsw i32 %%40, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_167_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%41, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_168_count);
  *(&aesl_internal_detectCoul_OC_cptG) = llvm_cbe_tmp__34;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_169_count);
  llvm_cbe_tmp__35 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__35);
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = add nsw i32 %%42, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_170_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%43, i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_171_count);
...
llvm_cbe_tmp__64:
if (AESL_DEBUG_TRACE)
printf("\n  %%brmerge10.demorgan = and i1 %%25, %%32, !dbg !10 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_brmerge10_2e_demorgan_count);
...
llvm_cbe_tmp__67:
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_174_count);
  llvm_cbe_tmp__37 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%47 = add nsw i32 %%46, 1, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_175_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%47, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !13 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_176_count);
  *(&aesl_internal_detectCoul_OC_cptR) = llvm_cbe_tmp__38;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_177_count);
  llvm_cbe_tmp__39 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = add nsw i32 %%48, 1, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_178_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%49, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_179_count);
  *(&aesl_internal_detectCoul_OC_cptG) = llvm_cbe_tmp__40;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__40);
if (AESL_DEBUG_TRACE)
printf("\n  %%50 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_180_count);
  llvm_cbe_tmp__41 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE)
printf("\n  %%51 = add nsw i32 %%50, 1, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_181_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%51, i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_182_count);
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%59 = load i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_190_count);
  llvm_cbe_tmp__43 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptPix);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__43);
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = add nsw i32 %%59, 1, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_191_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%60, i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_192_count);
  *(&aesl_internal_detectCoul_OC_cptPix) = llvm_cbe_tmp__44;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__44);
if (AESL_DEBUG_TRACE)
printf("\n  %%61 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_193_count);
  llvm_cbe_tmp__45 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__45);
if (AESL_DEBUG_TRACE)
printf("\n  %%62 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_194_count);
  llvm_cbe_tmp__46 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__46);
if (AESL_DEBUG_TRACE)
printf("\n  %%64 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_196_count);
  llvm_cbe_tmp__47 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__47);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond12 = and i1 %%63, %%65, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond12_count);
...
printf("\nor.cond12 = 0x%X\n", llvm_cbe_or_2e_cond12);
  if (llvm_cbe_or_2e_cond12) {
    llvm_cbe_storemerge33__PHI_TEMPORARY = (unsigned char )((unsigned char )2);   /* for PHI node */
...
llvm_cbe_tmp__70:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond14 = and i1 %%67, %%68, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond14_count);
...
printf("\nor.cond14 = 0x%X\n", llvm_cbe_or_2e_cond14);
  if (llvm_cbe_or_2e_cond14) {
    llvm_cbe_storemerge33__PHI_TEMPORARY = (unsigned char )((unsigned char )1);   /* for PHI node */
    llvm_cbe_storemerge27__PHI_TEMPORARY = (unsigned char )((unsigned char )1);   /* for PHI node */
    goto llvm_cbe_tmp__69;
  } else {
...
llvm_cbe_tmp__71:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond16 = and i1 %%70, %%71, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond16_count);
...
printf("\nor.cond16 = 0x%X\n", llvm_cbe_or_2e_cond16);
  if (llvm_cbe_or_2e_cond16) {
    llvm_cbe_storemerge33__PHI_TEMPORARY = (unsigned char )((unsigned char )0);   /* for PHI node */
    llvm_cbe_storemerge27__PHI_TEMPORARY = (unsigned char )((unsigned char )1);   /* for PHI node */
    goto llvm_cbe_tmp__69;
  } else {
...
llvm_cbe_tmp__72:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond18 = and i1 %%73, %%65, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond18_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond20 = and i1 %%74, %%63, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond20_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond34 = or i1 %%or.cond18, %%or.cond20, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond34_count);
  llvm_cbe_or_2e_cond34 = (bool )((llvm_cbe_or_2e_cond18 | llvm_cbe_or_2e_cond20)&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond34 = 0x%X\n", llvm_cbe_or_2e_cond34);
  if (llvm_cbe_or_2e_cond34) {
    llvm_cbe_storemerge33__PHI_TEMPORARY = (unsigned char )((unsigned char )2);   /* for PHI node */
    llvm_cbe_storemerge27__PHI_TEMPORARY = (unsigned char )((unsigned char )1);   /* for PHI node */
    goto llvm_cbe_tmp__69;
  } else {
...
llvm_cbe_tmp__73:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond22 = and i1 %%76, %%67, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond22_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge28 = zext i1 %%or.cond22 to i8, !dbg !14 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_storemerge28_count);
  llvm_cbe_storemerge28 = (unsigned char )((unsigned char )(bool )llvm_cbe_or_2e_cond22&1U);
if (AESL_DEBUG_TRACE)
printf("\nstoremerge28 = 0x%X\n", llvm_cbe_storemerge28);
  llvm_cbe_storemerge33__PHI_TEMPORARY = (unsigned char )llvm_cbe_storemerge28;   /* for PHI node */
  llvm_cbe_storemerge27__PHI_TEMPORARY = (unsigned char )llvm_cbe_storemerge28;   /* for PHI node */
  goto llvm_cbe_tmp__69;

llvm_cbe_tmp__69:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge33 = phi i8 [ 2, %%58 ], [ 1, %%66 ], [ 0, %%69 ], [ 2, %%72 ], [ %%storemerge28, %%75  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_storemerge33_count);
  llvm_cbe_storemerge33 = (unsigned char )llvm_cbe_storemerge33__PHI_TEMPORARY;
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge27 = phi i8 [ 1, %%58 ], [ 1, %%66 ], [ 1, %%69 ], [ 1, %%72 ], [ %%storemerge28, %%75  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_storemerge27_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%storemerge33, i8* %%resultats, align 1, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_210_count);
  *llvm_cbe_resultats = llvm_cbe_storemerge33;
if (AESL_DEBUG_TRACE)
printf("\nstoremerge33 = 0x%X\n", llvm_cbe_storemerge33);
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%storemerge27, i8* %%valid, align 1, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_211_count);
  *llvm_cbe_valid = llvm_cbe_storemerge27;
if (AESL_DEBUG_TRACE)
printf("\nstoremerge27 = 0x%X\n", llvm_cbe_storemerge27);
if (AESL_DEBUG_TRACE)
printf("\n  %%78 = load i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !15 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_212_count);
  llvm_cbe_tmp__48 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptPix);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__48);
  if (((llvm_cbe_tmp__48&4294967295U) == (107200u&4294967295U))) {
...
llvm_cbe_tmp__74:
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !15 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_215_count);
  *(&aesl_internal_detectCoul_OC_cptPix) = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !15 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_216_count);
  *(&aesl_internal_detectCoul_OC_cptB) = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !15 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_217_count);
  *(&aesl_internal_detectCoul_OC_cptG) = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !15 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_218_count);
...
printf("\n\{ BEGIN @traitCoul\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @seuilCout(%%struct.pixelType* %%pixOut, %%struct.pixelType* byval align 8 %%pixIn), !dbg !5 for 0x%llxth hint within @traitCoul  --> \n", ++aesl_llvm_cbe_230_count);
   /*tail*/ seuilCout((l_struct_OC_pixelType *)llvm_cbe_pixOut, *(llvm_cbe_pixIn));
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @detectCoul(i8* %%resultats, i8* %%valid, %%struct.pixelType* byval align 8 %%pixIn), !dbg !6 for 0x%llxth hint within @traitCoul  --> \n", ++aesl_llvm_cbe_231_count);
   /*tail*/ detectCoul(( char *)llvm_cbe_resultats, ( char *)llvm_cbe_valid, *(llvm_cbe_pixIn));
if (AESL_DEBUG_TRACE) {
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @traitCoul}\n");
