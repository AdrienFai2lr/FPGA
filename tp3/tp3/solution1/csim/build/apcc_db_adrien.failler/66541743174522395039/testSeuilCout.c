...
void detectCoul( char *,  char *, l_struct_OC_pixelType );
...
static  char aesl_internal__OC_str7[56] = "Valeur de i : %d, valeur du resultat : %u, valide : %u\n";
...
signed int main(void) {
  ...
  static  unsigned long long aesl_llvm_cbe_validOut_count = 0;
   char llvm_cbe_validOut;    /* Address-exposed local */
...
llvm_cbe_tmp__35:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([48 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
printf("\nReturn puts = 0x%X",llvm_cbe_puts);
  ...
  llvm_cbe_tmp__34__PHI_TEMPORARY = (unsigned int )1u;   /* for PHI node */
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds %%struct.pixelType* %%res, i64 0, i32 2, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__3 = (signed int *)(&llvm_cbe_res.field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds %%struct.pixelType* %%res, i64 0, i32 1, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_39_count);
  llvm_cbe_tmp__4 = (signed int *)(&llvm_cbe_res.field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds %%struct.pixelType* %%res, i64 0, i32 0, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_40_count);
...
llvm_cbe_tmp__38:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts1 = call i32 @puts(i8* getelementptr inbounds ([53 x i8]* @aesl_internal_str1, i64 0, i64 0)), !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_puts1_count);
...
llvm_cbe_tmp__39:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ 0, %%.preheader ], [ %%52, %%51  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = call i32 (%%struct._IO_FILE*, i8*, ...)* @__isoc99_fscanf(%%struct._IO_FILE* %%1, i8* getelementptr inbounds ([3 x i8]* @aesl_internal_.str6, i64 0, i64 0), i32* %%g) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_44_count);
  __isoc99_fscanf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__1, ( char *)((&aesl_internal__OC_str6[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = load i32* %%b, align 4, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_52_count);
  llvm_cbe_tmp__9 = (unsigned int )*(&llvm_cbe_b);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%15, i32* %%7, align 4, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_53_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = load i32* %%g, align 4, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__10 = (unsigned int )*(&llvm_cbe_g);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%16, i32* %%8, align 4, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  *llvm_cbe_tmp__4 = llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i32* %%r, align 4, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_68_count);
  llvm_cbe_tmp__11 = (unsigned int )*(&llvm_cbe_r);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%17, i32* %%9, align 4, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_69_count);
  *llvm_cbe_tmp__5 = llvm_cbe_tmp__11;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  call void @detectCoul(i8* %%resOut, i8* %%validOut, %%struct.pixelType* byval align 8 %%res) nounwind, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  detectCoul(( char *)(&llvm_cbe_resOut), ( char *)(&llvm_cbe_validOut), llvm_cbe_res);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i8* %%resOut, align 1, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__12 = (unsigned char )*(&llvm_cbe_resOut);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = zext i8 %%18 to i32, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_78_count);
  llvm_cbe_tmp__13 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__12&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = load i8* %%validOut, align 1, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_85_count);
  llvm_cbe_tmp__14 = (unsigned char )*(&llvm_cbe_validOut);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = zext i8 %%20 to i32, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_86_count);
  llvm_cbe_tmp__15 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__14&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([56 x i8]* @aesl_internal_.str7, i64 0, i64 0), i32 %%storemerge2, i32 %%19, i32 %%21) nounwind, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_87_count);
  printf(( char *)((&aesl_internal__OC_str7[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 56
#endif
])), llvm_cbe_storemerge2, llvm_cbe_tmp__13, llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = load i8* %%validOut, align 1, !dbg !15 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_94_count);
  llvm_cbe_tmp__17 = (unsigned char )*(&llvm_cbe_validOut);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
  if (((llvm_cbe_tmp__17&255U) == (((unsigned char )0)&255U))) {
...
llvm_cbe_tmp__42:
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = add nsw i32 %%storemerge2, 1, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_131_count);
  llvm_cbe_tmp__31 = (unsigned int )((unsigned int )(llvm_cbe_storemerge2&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__31&4294967295ull)));
  if (((llvm_cbe_tmp__31&4294967295U) == (107200u&4294967295U))) {
    goto llvm_cbe_tmp__43;
  } else {
    llvm_cbe_storemerge2__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__31;   /* for PHI node */
    goto llvm_cbe_tmp__39;
  }
...
llvm_cbe_tmp__45:
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 255) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_106_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 0) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 0) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_108_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
llvm_cbe_tmp__41:
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i8* %%resOut, align 1, !dbg !15 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_103_count);
  llvm_cbe_tmp__18 = (unsigned char )*(&llvm_cbe_resOut);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
  if (((llvm_cbe_tmp__18&255U) == (((unsigned char )2)&255U))) {
...
llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 0) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_113_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 255) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_114_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
llvm_cbe_tmp__46:
  if (((llvm_cbe_tmp__18&255U) == (((unsigned char )1)&255U))) {
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 0) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_120_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 0) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_121_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 255) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_122_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
llvm_cbe_tmp__40:
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 128) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_127_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 128) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_128_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%50 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 128) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_129_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
llvm_cbe_tmp__43:
if (AESL_DEBUG_TRACE)
printf("\n  %%54 = call i32 @fclose(%%struct._IO_FILE* %%1) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_137_count);
  fclose((l_struct_OC__IO_FILE *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__32);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = call i32 @fclose(%%struct._IO_FILE* %%2) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_138_count);
...
llvm_cbe_tmp__37:
if (AESL_DEBUG_TRACE)
printf("\n  %%57 = phi i32 [ 0, %%53 ], [ 1, %%10 ], [ 1, %%4  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_140_count);
