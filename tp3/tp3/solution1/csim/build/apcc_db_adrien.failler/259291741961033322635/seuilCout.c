...
static  char aesl_internal__OC_str[26] = "rouge %u vert %u bleu %u\n";
...
void detectCoul( char *llvm_cbe_res, l_struct_OC_pixelType llvm_cbe_pixIn) {
  ...
  static  unsigned long long aesl_llvm_cbe_notlhs26_count = 0;
  static  unsigned long long aesl_llvm_cbe_notrhs27_count = 0;
  static  unsigned long long aesl_llvm_cbe_or_2e_cond21_2e_not_count = 0;
  bool llvm_cbe_or_2e_cond21_2e_not;
  ...
  static  unsigned long long aesl_llvm_cbe_or_2e_cond23_2e_not_count = 0;
  bool llvm_cbe_or_2e_cond23_2e_not;
...
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond18 = and i1 %%7, %%8, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond18_count);
  llvm_cbe_or_2e_cond18 = (bool )((((llvm_cbe_tmp__16&4294967295U) == (llvm_cbe_tmp__14&4294967295U)) & ((llvm_cbe_tmp__14&4294967295U) == (llvm_cbe_tmp__18&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__43:
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_89_count);
  llvm_cbe_tmp__19 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = add nsw i32 %%10, 1, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_90_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%11, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_91_count);
  *(&aesl_internal_detectCoul_OC_cptR) = llvm_cbe_tmp__20;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_92_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%13, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_94_count);
...
llvm_cbe_tmp__44:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond19.not = and i1 %%notrhs, %%notlhs, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond19_2e_not_count);
  llvm_cbe_or_2e_cond19_2e_not = (bool )(((((signed int )llvm_cbe_tmp__18) >= ((signed int )llvm_cbe_tmp__14)) & (((signed int )llvm_cbe_tmp__18) >= ((signed int )llvm_cbe_tmp__16)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond19.not = 0x%X\n", llvm_cbe_or_2e_cond19_2e_not);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond20 = and i1 %%or.cond19.not, %%phitmp, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond20_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond21.not = and i1 %%notrhs27, %%notlhs26, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond21_2e_not_count);
  llvm_cbe_or_2e_cond21_2e_not = (bool )(((((signed int )llvm_cbe_tmp__16) >= ((signed int )llvm_cbe_tmp__14)) & (((signed int )llvm_cbe_tmp__16) >= ((signed int )llvm_cbe_tmp__18)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond21.not = 0x%X\n", llvm_cbe_or_2e_cond21_2e_not);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond22 = and i1 %%or.cond21.not, %%phitmp1, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond22_count);
  llvm_cbe_or_2e_cond22 = (bool )((llvm_cbe_or_2e_cond21_2e_not & ((llvm_cbe_tmp__16&4294967295U) != (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__46:
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_107_count);
  llvm_cbe_tmp__27 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = add nsw i32 %%21, 1, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_108_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%22, i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_109_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond23.not = and i1 %%notrhs29, %%notlhs28, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond23_2e_not_count);
  llvm_cbe_or_2e_cond23_2e_not = (bool )(((((signed int )llvm_cbe_tmp__14) >= ((signed int )llvm_cbe_tmp__16)) & (((signed int )llvm_cbe_tmp__14) >= ((signed int )llvm_cbe_tmp__18)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond23.not = 0x%X\n", llvm_cbe_or_2e_cond23_2e_not);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond24 = and i1 %%or.cond23.not, %%phitmp2, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond24_count);
  llvm_cbe_or_2e_cond24 = (bool )((llvm_cbe_or_2e_cond23_2e_not & ((llvm_cbe_tmp__14&4294967295U) != (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__47:
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__29 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = add nsw i32 %%24, 1, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_114_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%25, i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_115_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__31 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_119_count);
  llvm_cbe_tmp__32 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = and i1 %%27, %%29, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
  llvm_cbe_or_2e_cond = (bool )(((((signed int )llvm_cbe_tmp__31) > ((signed int )0u)) & ((llvm_cbe_tmp__32&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond = 0x%X\n", llvm_cbe_or_2e_cond);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_121_count);
  llvm_cbe_tmp__33 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond7 = and i1 %%or.cond, %%31, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond7_count);
  llvm_cbe_or_2e_cond7 = (bool )((llvm_cbe_or_2e_cond & ((llvm_cbe_tmp__33&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond7 = 0x%X\n", llvm_cbe_or_2e_cond7);
  if (llvm_cbe_or_2e_cond7) {
    llvm_cbe_tmp__35__PHI_TEMPORARY = (unsigned char )((unsigned char )2);   /* for PHI node */
...
llvm_cbe_tmp__49:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond9 = and i1 %%33, %%34, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond9_count);
  llvm_cbe_or_2e_cond9 = (bool )(((((signed int )llvm_cbe_tmp__32) > ((signed int )0u)) & ((llvm_cbe_tmp__31&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond9 = 0x%X\n", llvm_cbe_or_2e_cond9);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond11 = and i1 %%or.cond9, %%31, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond11_count);
  llvm_cbe_or_2e_cond11 = (bool )((llvm_cbe_or_2e_cond9 & ((llvm_cbe_tmp__33&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__50:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond13 = and i1 %%36, %%34, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond13_count);
  llvm_cbe_or_2e_cond13 = (bool )(((((signed int )llvm_cbe_tmp__33) > ((signed int )0u)) & ((llvm_cbe_tmp__31&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond13 = 0x%X\n", llvm_cbe_or_2e_cond13);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond15 = and i1 %%or.cond13, %%29, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond15_count);
  llvm_cbe_or_2e_cond15 = (bool )((llvm_cbe_or_2e_cond13 & ((llvm_cbe_tmp__32&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond15 = 0x%X\n", llvm_cbe_or_2e_cond15);
  if (llvm_cbe_or_2e_cond15) {
    llvm_cbe_tmp__35__PHI_TEMPORARY = (unsigned char )((unsigned char )0);   /* for PHI node */
    goto llvm_cbe_tmp__48;
  } else {
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond17 = or i1 %%33, %%36, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond17_count);
  llvm_cbe_or_2e_cond17 = (bool )(((((signed int )llvm_cbe_tmp__32) > ((signed int )0u)) | (((signed int )llvm_cbe_tmp__33) > ((signed int )0u)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond17 = 0x%X\n", llvm_cbe_or_2e_cond17);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond25 = and i1 %%27, %%or.cond17, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond25_count);
  llvm_cbe_or_2e_cond25 = (bool )(((((signed int )llvm_cbe_tmp__31) > ((signed int )0u)) & llvm_cbe_or_2e_cond17)&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond25 = 0x%X\n", llvm_cbe_or_2e_cond25);
  if (llvm_cbe_or_2e_cond25) {
    llvm_cbe_tmp__35__PHI_TEMPORARY = (unsigned char )((unsigned char )2);   /* for PHI node */
    goto llvm_cbe_tmp__48;
  } else {
...
llvm_cbe_tmp__52:
if (AESL_DEBUG_TRACE)
printf("\n  %%. = and i1 %%33, %%36, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe__2e__count);
  llvm_cbe__2e_ = (bool )(((((signed int )llvm_cbe_tmp__32) > ((signed int )0u)) & (((signed int )llvm_cbe_tmp__33) > ((signed int )0u)))&1);
if (AESL_DEBUG_TRACE)
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = zext i1 %%. to i for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_130_count);
  llvm_cbe_tmp__34 = (unsigned char )((unsigned char )(bool )llvm_cbe__2e_&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__34);
  llvm_cbe_tmp__35__PHI_TEMPORARY = (unsigned char )llvm_cbe_tmp__34;   /* for PHI node */
  goto llvm_cbe_tmp__48;

llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = phi i8 [ 2, %%.critedge4 ], [ 1, %%32 ], [ 0, %%35 ], [ %%39, %%38 ], [ 2, %%37  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_132_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%41, i8* %%res, align  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_133_count);
  *llvm_cbe_res = llvm_cbe_tmp__35;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__35);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = load i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_134_count);
  llvm_cbe_tmp__36 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptPix);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = add nsw i32 %%42, 1, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_135_count);
  llvm_cbe_tmp__37 = (unsigned int )((unsigned int )(llvm_cbe_tmp__36&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__37&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%43, i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_136_count);
  *(&aesl_internal_detectCoul_OC_cptPix) = llvm_cbe_tmp__37;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_137_count);
  llvm_cbe_tmp__38 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_138_count);
  llvm_cbe_tmp__39 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_139_count);
  llvm_cbe_tmp__40 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__40);
if (AESL_DEBUG_TRACE)
printf("\n  %%47 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%44, i32 %%45, i32 %%46) nounwind, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_140_count);
   /*tail*/ printf(( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 26
#endif
])), llvm_cbe_tmp__38, llvm_cbe_tmp__39, llvm_cbe_tmp__40);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = load i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_141_count);
  llvm_cbe_tmp__42 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptPix);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__42);
  if (((llvm_cbe_tmp__42&4294967295U) == (107200u&4294967295U))) {
