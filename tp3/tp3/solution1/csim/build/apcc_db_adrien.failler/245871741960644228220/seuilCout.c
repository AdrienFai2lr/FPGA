...
void detectCoul( char *llvm_cbe_res, l_struct_OC_pixelType llvm_cbe_pixIn) {
  ...
  static  unsigned long long aesl_llvm_cbe_notlhs25_count = 0;
  static  unsigned long long aesl_llvm_cbe_notrhs26_count = 0;
  static  unsigned long long aesl_llvm_cbe_or_2e_cond20_2e_not_count = 0;
  bool llvm_cbe_or_2e_cond20_2e_not;
  ...
  static  unsigned long long aesl_llvm_cbe_notlhs27_count = 0;
  static  unsigned long long aesl_llvm_cbe_notrhs28_count = 0;
  static  unsigned long long aesl_llvm_cbe_or_2e_cond22_2e_not_count = 0;
  bool llvm_cbe_or_2e_cond22_2e_not;
  ...
  unsigned char llvm_cbe_tmp__29__PHI_TEMPORARY;
...
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond18.not = and i1 %%notrhs, %%notlhs, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond18_2e_not_count);
  llvm_cbe_or_2e_cond18_2e_not = (bool )(((((signed int )llvm_cbe_tmp__18) >= ((signed int )llvm_cbe_tmp__14)) & (((signed int )llvm_cbe_tmp__18) >= ((signed int )llvm_cbe_tmp__16)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond18.not = 0x%X\n", llvm_cbe_or_2e_cond18_2e_not);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond19 = and i1 %%or.cond18.not, %%phitmp, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond19_count);
  llvm_cbe_or_2e_cond19 = (bool )((llvm_cbe_or_2e_cond18_2e_not & ((llvm_cbe_tmp__18&4294967295U) != (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond20.not = and i1 %%notrhs26, %%notlhs25, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond20_2e_not_count);
  llvm_cbe_or_2e_cond20_2e_not = (bool )(((((signed int )llvm_cbe_tmp__16) >= ((signed int )llvm_cbe_tmp__14)) & (((signed int )llvm_cbe_tmp__16) >= ((signed int )llvm_cbe_tmp__18)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond20.not = 0x%X\n", llvm_cbe_or_2e_cond20_2e_not);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond21 = and i1 %%or.cond20.not, %%phitmp1, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond21_count);
  llvm_cbe_or_2e_cond21 = (bool )((llvm_cbe_or_2e_cond20_2e_not & ((llvm_cbe_tmp__16&4294967295U) != (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond22.not = and i1 %%notrhs28, %%notlhs27, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond22_2e_not_count);
  llvm_cbe_or_2e_cond22_2e_not = (bool )(((((signed int )llvm_cbe_tmp__14) >= ((signed int )llvm_cbe_tmp__16)) & (((signed int )llvm_cbe_tmp__14) >= ((signed int )llvm_cbe_tmp__18)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond22.not = 0x%X\n", llvm_cbe_or_2e_cond22_2e_not);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond23 = and i1 %%or.cond22.not, %%phitmp2, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond23_count);
  llvm_cbe_or_2e_cond23 = (bool )((llvm_cbe_or_2e_cond22_2e_not & ((llvm_cbe_tmp__14&4294967295U) != (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
...
printf("\n = 0x%X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_102_count);
  llvm_cbe_tmp__26 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = and i1 %%17, %%19, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
  llvm_cbe_or_2e_cond = (bool )(((((signed int )llvm_cbe_tmp__25) > ((signed int )0u)) & ((llvm_cbe_tmp__26&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond = 0x%X\n", llvm_cbe_or_2e_cond);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_104_count);
  llvm_cbe_tmp__27 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond7 = and i1 %%or.cond, %%21, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond7_count);
  llvm_cbe_or_2e_cond7 = (bool )((llvm_cbe_or_2e_cond & ((llvm_cbe_tmp__27&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond7 = 0x%X\n", llvm_cbe_or_2e_cond7);
  if (llvm_cbe_or_2e_cond7) {
    llvm_cbe_tmp__29__PHI_TEMPORARY = (unsigned char )((unsigned char )2);   /* for PHI node */
...
llvm_cbe_tmp__41:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond9 = and i1 %%23, %%24, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond9_count);
  llvm_cbe_or_2e_cond9 = (bool )(((((signed int )llvm_cbe_tmp__26) > ((signed int )0u)) & ((llvm_cbe_tmp__25&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond9 = 0x%X\n", llvm_cbe_or_2e_cond9);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond11 = and i1 %%or.cond9, %%21, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond11_count);
  llvm_cbe_or_2e_cond11 = (bool )((llvm_cbe_or_2e_cond9 & ((llvm_cbe_tmp__27&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond11 = 0x%X\n", llvm_cbe_or_2e_cond11);
  if (llvm_cbe_or_2e_cond11) {
    llvm_cbe_tmp__29__PHI_TEMPORARY = (unsigned char )((unsigned char )1);   /* for PHI node */
    goto llvm_cbe_tmp__40;
  } else {
...
llvm_cbe_tmp__42:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond13 = and i1 %%26, %%24, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond13_count);
  llvm_cbe_or_2e_cond13 = (bool )(((((signed int )llvm_cbe_tmp__27) > ((signed int )0u)) & ((llvm_cbe_tmp__25&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond13 = 0x%X\n", llvm_cbe_or_2e_cond13);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond15 = and i1 %%or.cond13, %%19, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond15_count);
  llvm_cbe_or_2e_cond15 = (bool )((llvm_cbe_or_2e_cond13 & ((llvm_cbe_tmp__26&4294967295U) == (0u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond15 = 0x%X\n", llvm_cbe_or_2e_cond15);
  if (llvm_cbe_or_2e_cond15) {
    llvm_cbe_tmp__29__PHI_TEMPORARY = (unsigned char )((unsigned char )0);   /* for PHI node */
    goto llvm_cbe_tmp__40;
  } else {
...
llvm_cbe_tmp__43:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond17 = or i1 %%23, %%26, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond17_count);
  llvm_cbe_or_2e_cond17 = (bool )(((((signed int )llvm_cbe_tmp__26) > ((signed int )0u)) | (((signed int )llvm_cbe_tmp__27) > ((signed int )0u)))&1);
if (AESL_DEBUG_TRACE)
printf("\nor.cond17 = 0x%X\n", llvm_cbe_or_2e_cond17);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond24 = and i1 %%17, %%or.cond17, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond24_count);
  llvm_cbe_or_2e_cond24 = (bool )(((((signed int )llvm_cbe_tmp__25) > ((signed int )0u)) & llvm_cbe_or_2e_cond17)&1);
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__44:
if (AESL_DEBUG_TRACE)
printf("\n  %%. = and i1 %%23, %%26, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe__2e__count);
  llvm_cbe__2e_ = (bool )(((((signed int )llvm_cbe_tmp__26) > ((signed int )0u)) & (((signed int )llvm_cbe_tmp__27) > ((signed int )0u)))&1);
if (AESL_DEBUG_TRACE)
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = zext i1 %%. to i for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__28 = (unsigned char )((unsigned char )(bool )llvm_cbe__2e_&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__28);
  llvm_cbe_tmp__29__PHI_TEMPORARY = (unsigned char )llvm_cbe_tmp__28;   /* for PHI node */
  goto llvm_cbe_tmp__40;

llvm_cbe_tmp__40:
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = phi i8 [ 2, %%.critedge4 ], [ 1, %%22 ], [ 0, %%25 ], [ %%29, %%28 ], [ 2, %%27  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_115_count);
  llvm_cbe_tmp__29 = (unsigned char )llvm_cbe_tmp__29__PHI_TEMPORARY;
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%31, i8* %%res, align  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_116_count);
  *llvm_cbe_res = llvm_cbe_tmp__29;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = load i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__30 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptPix);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = add nsw i32 %%32, 1, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_118_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%33, i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_119_count);
  *(&aesl_internal_detectCoul_OC_cptPix) = llvm_cbe_tmp__31;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_120_count);
  llvm_cbe_tmp__32 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = load i32* @aesl_internal_detectCoul.cptG, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_121_count);
  llvm_cbe_tmp__33 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptG);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = load i32* @aesl_internal_detectCoul.cptB, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_122_count);
  llvm_cbe_tmp__34 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptB);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%34, i32 %%35, i32 %%36) nounwind, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_123_count);
   /*tail*/ printf(( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 26
#endif
])), llvm_cbe_tmp__32, llvm_cbe_tmp__33, llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = load i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !7 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_124_count);
  llvm_cbe_tmp__36 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptPix);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__36);
  if (((llvm_cbe_tmp__36&4294967295U) == (107200u&4294967295U))) {
