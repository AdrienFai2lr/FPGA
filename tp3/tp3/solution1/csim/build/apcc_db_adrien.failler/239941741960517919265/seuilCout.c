...
static  char aesl_internal__OC_str[25] = "rouge %u vert %u bleu %u";
...
printf("\n = 0x%X\n", llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%34, i32 %%35, i32 %%36) nounwind, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_123_count);
