...
void detectCoul(signed int *llvm_cbe_res, l_struct_OC_pixelType llvm_cbe_pixIn);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond18.not = and i1 %%notrhs, %%notlhs, !dbg !4 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_or_2e_cond18_2e_not_count);
...
llvm_cbe_tmp__32:
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_84_count);
  llvm_cbe_tmp__19 = (unsigned int )*(&aesl_internal_detectCoul_OC_cptR);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%8, 1, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_85_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%9, i32* @aesl_internal_detectCoul.cptR, align 4, !dbg !5 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_86_count);
...
printf("\nor.cond7 = 0x%X\n", llvm_cbe_or_2e_cond7);
  if (llvm_cbe_or_2e_cond7) {
    llvm_cbe_tmp__29__PHI_TEMPORARY = (unsigned int )2u;   /* for PHI node */
...
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = zext i1 %%. to i3 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__28 = (unsigned int )((unsigned int )(bool )llvm_cbe__2e_&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__28);
  llvm_cbe_tmp__29__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__28;   /* for PHI node */
  goto llvm_cbe_tmp__35;

llvm_cbe_tmp__35:
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = phi i32 [ 2, %%.critedge4 ], [ 1, %%22 ], [ 0, %%25 ], [ %%29, %%28 ], [ 2, %%27  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_115_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%31, i32* %%res, align  for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_116_count);
...
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
  if (((llvm_cbe_tmp__31&4294967295U) == (107200u&4294967295U))) {
...
llvm_cbe_tmp__40:
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* @aesl_internal_detectCoul.cptPix, align 4, !dbg !6 for 0x%llxth hint within @detectCoul  --> \n", ++aesl_llvm_cbe_122_count);
