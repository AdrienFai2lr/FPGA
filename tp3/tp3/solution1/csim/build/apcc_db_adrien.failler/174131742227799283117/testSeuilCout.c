...
llvm_cbe_tmp__36:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ 0, %%.preheader ], [ %%49, %%48  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
llvm_cbe_tmp__39:
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = add nsw i32 %%storemerge2, 1, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_116_count);
  llvm_cbe_tmp__28 = (unsigned int )((unsigned int )(llvm_cbe_storemerge2&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__28&4294967295ull)));
  if (((llvm_cbe_tmp__28&4294967295U) == (107200u&4294967295U))) {
    goto llvm_cbe_tmp__40;
  } else {
    llvm_cbe_storemerge2__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__28;   /* for PHI node */
    goto llvm_cbe_tmp__36;
  }
...
llvm_cbe_tmp__46:
  if (((llvm_cbe_tmp__15&255U) == (((unsigned char )3)&255U))) {
...
llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 128) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_109_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 128) nounwind, !dbg !12 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_110_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%2, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str8, i64 0, i64 0), i32 128) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_111_count);
  fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__2, ( char *)((&aesl_internal__OC_str8[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
...
llvm_cbe_tmp__40:
if (AESL_DEBUG_TRACE)
printf("\n  %%51 = call i32 @fclose(%%struct._IO_FILE* %%1) nounwind, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_122_count);
  fclose((l_struct_OC__IO_FILE *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__29);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = call i32 @fclose(%%struct._IO_FILE* %%2) nounwind, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_123_count);
...
llvm_cbe_tmp__34:
if (AESL_DEBUG_TRACE)
printf("\n  %%54 = phi i32 [ 0, %%50 ], [ 1, %%10 ], [ 1, %%4  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_125_count);
