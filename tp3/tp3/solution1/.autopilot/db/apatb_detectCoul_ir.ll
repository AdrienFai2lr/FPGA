...
define void @apatb_detectCoul_ir(i8* noalias nocapture nonnull %resultats, i8* noalias nocapture nonnull %valid, %struct.pixelType* nocapture readonly %pixIn) local_unnamed_addr #0 {
entry:
  %resultats_copy = alloca i8, align 512
  %valid_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %resultats, i8* nonnull align 512 %resultats_copy, i8* nonnull %valid, i8* nonnull align 512 %valid_copy)
  call void @apatb_detectCoul_hw(i8* %resultats_copy, i8* %valid_copy, %struct.pixelType* %pixIn)
  call void @copy_back(i8* %resultats, i8* %resultats_copy, i8* %valid, i8* %valid_copy)
  ret void
}
...
declare void @apatb_detectCoul_hw(i8*, i8*, %struct.pixelType*)
...
define void @detectCoul_hw_stub_wrapper(i8*, i8*, %struct.pixelType*) #4 {
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %1)
  call void @detectCoul_hw_stub(i8* %0, i8* %1, %struct.pixelType* %2)
  call void @copy_in(i8* null, i8* %0, i8* null, i8* %1)
  ret void
}

declare void @detectCoul_hw_stub(i8*, i8*, %struct.pixelType*)
