...
void exo1(signed int *, signed int , signed int , signed int , signed int );
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @exo1(i32* %%output, i32 23, i32 50, i32 13, i32 9) nounwind, !dbg !9 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_15_count);
  exo1((signed int *)(&llvm_cbe_output), 23u, 50u, 13u, 9u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",23u);
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",13u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @exo1(i32* %%output, i32 23, i32 50, i32 15, i32 20) nounwind, !dbg !9 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  exo1((signed int *)(&llvm_cbe_output), 23u, 50u, 15u, 20u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",23u);
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",15u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @exo1(i32* %%output, i32 23, i32 50, i32 10, i32 5) nounwind, !dbg !9 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  exo1((signed int *)(&llvm_cbe_output), 23u, 50u, 10u, 5u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",23u);
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",10u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @exo1(i32* %%output, i32 23, i32 50, i32 1, i32 8) nounwind, !dbg !9 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_33_count);
  exo1((signed int *)(&llvm_cbe_output), 23u, 50u, 1u, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",23u);
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @exo1(i32* %%output, i32 23, i32 50, i32 19, i32 32) nounwind, !dbg !9 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_39_count);
  exo1((signed int *)(&llvm_cbe_output), 23u, 50u, 19u, 32u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",23u);
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",19u);
...
llvm_cbe_tmp__20:
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load %%struct._IO_FILE** @stdout, align 8, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_59_count);
  llvm_cbe_tmp__6 = (l_struct_OC__IO_FILE *)*(&stdout);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i64 0, i64 0), i64 44, i64 1, %%struct._IO_FILE* %%8), !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_60_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load %%struct._IO_FILE** @stdout, align 8, !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  llvm_cbe_tmp__8 = (l_struct_OC__IO_FILE *)*(&stdout);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = call i64 @fwrite(i8* getelementptr inbounds ([47 x i8]* @aesl_internal_.str6, i64 0, i64 0), i64 46, i64 1, %%struct._IO_FILE* %%10), !dbg !11 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
...
llvm_cbe_tmp__21:
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = phi i32 [ 0, %%14 ], [ 1, %%7  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_73_count);
