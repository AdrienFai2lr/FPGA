...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load %%struct._IO_FILE** @stdout, align 8, !dbg !10 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  llvm_cbe_tmp__10 = (l_struct_OC__IO_FILE *)*(&stdout);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i64 0, i64 0), i64 44, i64 1, %%struct._IO_FILE* %%12), !dbg !10 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
  fwrite(( char *)((&aesl_internal__OC_str5[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 45
#endif
...
llvm_cbe_tmp__20:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ 1, %%7 ], [ 0, %%14  for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge1_count);
