...
$(ObjDir)/exo1_test.c_pre.c.tb.o : exo1_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) exo1_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/exo1.c_pre.c.tb.o : exo1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) exo1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
