...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "exo1.autotvin.dat"
	set constFileTvOut       "exo1.autotvout.dat"
	set constFileHdlTvIn     "exo1.autohdltvin.dat"
	set constFileHdlTvOut    "exo1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
